...
public class FilterTypeSale : IItemQuery<FilterTypeSaleDto>
{
    public sealed class Handler : IQueryHandler<FilterTypeSale, ResultModel<FilterTypeSaleDto>>
    {
        ...
        public async ValueTask<ResultModel<FilterTypeSaleDto>> Handle(FilterTypeSale query, CancellationToken cancellationToken)
        {
            FilterTypeSaleDto result = new();
            ...
            return ResultModel<FilterTypeSaleDto>.Create(result);
        }
    }
}
